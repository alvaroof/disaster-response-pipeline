...
#         precision.append(precision_score(Y_test[col].values, pd.DataFrame(Y_pred).iloc[:,i]))
#         recall.append(recall_score(Y_test[col].values, pd.DataFrame(Y_pred).iloc[:,i]))
#         f1.append(f1_score(Y_test[col].values, pd.DataFrame(Y_pred).iloc[:,i]))
        
#     df = pd.DataFrame({'f1':f1, 'precision':precision, 'recall':recall})
#     df['variable'] =list(Y_test.columns)
